...
/*!
 * \brief Stops the uplink retransmissionTXDONE
 *
            ...
            switch( fType )
            {
                ...
                {  /* +----------+------+-------+--------------+
                    ...
                    */
                    ...
                    ProcessMacCommands( macMsgData.FHDR.FOpts, 5, macMsgData.FHDR.FCtrl.Bits.FOptsLen, snr, MacCtx.McpsIndication.RxSlot ); //BASHIR 8 was 0
...
static void OnRxWindow1TimerEvent( void )
{
    ...
    MacCtx.RxWindow1Config.RxContinuous = false; //avi false;
        ...
        switch( payload[macIndex++] )
        {
            ...
            case SRV_MAC_LINK_ADR_REQ:
            {
                ...
                if( adrBlockFound == false )
                {
                    ...
                    {
                        int res = LoRaMacCommandsAddCmd( MOTE_MAC_LINK_ADR_ANS, &status, 1 );
//                    	PRINTF("--------------------------add mac command, status : %d\n", res);
                    }
                    // Update MAC index
            ...
            case SRV_MAC_DUTY_CYCLE_REQ:
            {
                ...
                int res = LoRaMacCommandsAddCmd( MOTE_MAC_DUTY_CYCLE_ANS, macCmdPayload, 1 );
				PRINTF("......................................................................%d\n",res);
...
static LoRaMacStatus_t ScheduleTx( bool allowDelayedTx )
{
    ...
    else
    {
        ...
        //PRINTF("############################################################################################## %d:   %d\n",MacCtx.NvmCtx->MacParams.ReceiveDelay1,MacCtx.RxWindow1Config.WindowOffset);
    }
